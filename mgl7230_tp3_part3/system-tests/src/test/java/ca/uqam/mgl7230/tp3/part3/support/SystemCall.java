package ca.uqam.mgl7230.tp3.part3.support;
...
public class SystemCall {
    ...
    public SystemCall(final RestTemplate restTemplate) {
        this.restTemplate = restTemplate;
    }

    public ResponseEntity<String> call(final ArrayNode requestBody) {
        String port = "8081";
        String targetUrl = "http://localhost:" + port + "/flight/frontend";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<ArrayNode> requestEntity = new HttpEntity<>(requestBody, headers);
    ...
    public ResponseEntity<String> call(final List<FlightPostRequest> requestBody) {
        String port = "8080";
